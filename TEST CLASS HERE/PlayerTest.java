...
public class PlayerTest {
	...
	public void test_hasEnoughFunds_ExactAmount() {
		Player testPlayer = new Player(20,20);
		assertEquals("Player has 20 money, checking if 20 price is affordable", true, testPlayer.hasEnoughFunds(20));
	}
	
	@Test
	public void test_hasEnoughFunds_MoreThanEnough() {
		Player testPlayer = new Player(20,20);
		assertEquals("Player has 20 money, checking if 5 price is affordable", true, testPlayer.hasEnoughFunds(5));
	}
	
	@Test
	public void test_hasEnoughFunds_NotEnough() {
		Player testPlayer = new Player(20,20);
		assertEquals("Player has 20 money, checking if 50 price is affordable", false, testPlayer.hasEnoughFunds(50));
	}
